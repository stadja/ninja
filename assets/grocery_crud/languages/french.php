...
/* Translated by ASMAAYNI */
	...
	$lang['form_save_and_go_back']	= 'Sauver et retourner à la liste';
	...
	$lang['error_on_uploading'] 	= "Une erreur s'est produite pendant l'upload.";
	$lang['message_prompt_delete_file'] 	= "Êtes-vous certain de vouloir supprimer ce fichier ?";
	
	$lang['error_max_number_of_files'] 	= "Vous ne pouvez qu'uploader un fichier à la fois.";
	$lang['error_accept_file_types'] 	= "Vous ne pouvez pas uploader de fichier de ce type.";
	$lang['error_max_file_size'] 		= "La taille du fichier excède la limite du dossier.";
	$lang['error_min_file_size'] 		= "Vous ne pouvez uploader un fichier vide.";