<div id="header-content" class="wrapper clearfix">
	...
	<a href="<?php echo base_url('reader');?>" style="float:right;" class="perso <?php echo $selected ?>">Lire</a>

	<?php if ($user->hasRights('cdc')) :?>
		<?php $selected = ($page_news == 'write') ? 'selected' : ''; ?>
		<a href="<?php echo base_url('cdc/addNews');?>" style="float:right;" class="perso <?php echo $selected ?>">Ecrire</a>
	<?php endif; ?>

	<?php $selected = ($page_news == 'setup') ? 'selected' : ''; ?>
	<a class="perso <?php echo $selected ?>" style="float:right;" href="<?php echo base_url('reader/setup');?>">Personnaliser</a>
